...
export const experience: Experience[] = [
  {
    ...
    description: "Desarrollador Frontend en la empresa de seguros National Unity, trabajando en el desarrollo de la página web de la empresa, así como en el diseño y creación de una nueva aplicación web para todas las áreas de la empresa."
  },
  {
